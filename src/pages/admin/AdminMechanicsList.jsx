  ...
  return (
    <div>
      <div className='flex gap-2 text-xs'>
        ...
        <NavLink to='targets' className={({ isActive }) => `${isActive ? 'child-nav' : 'p-2 rounded-sm border border-primaryColor hover:bg-primaryColor hover:text-white active:opacity-90'}`}><button className=''>Targets</button></NavLink>
      </div>
      <div>
        <Outlet />
      </div>
