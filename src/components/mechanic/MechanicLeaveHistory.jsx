    ...
    return (
        <div>
            <div className='flex justify-between items-center'>
                <h1 className='font-semibold text-2xl pb-4'>Leave History</h1>
                {/* Filter Options */}
                <div className='pb-1'>
                    <label htmlFor='statusFilter' className='mr-2 text-sm text-slate-400'>Filter by status:</label>
                    <select
                        id='statusFilter'
                        value={statusFilter}
                        onChange={handleFilterChange}
                        className='bg-primaryColor cursor-pointer outline-none text-sm text-white p-1 rounded'
                    >
            ...
            <div className='overflow-y-auto scrollbar-none  max-h-[500px]'>
